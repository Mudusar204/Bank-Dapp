    ...
    <>
      {window.ethereum ? (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-purple-500">
         ...
         <Link to={"/token"}>
          <button className="w-full mb-3 bg-purple-600 py-3 px-4 whitespace-nowrap text-white rounded-md hover:bg-purple-700">
           ERC20 Token
          </button>
         </Link>
